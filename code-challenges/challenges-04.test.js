...
let hangman = (str) => {
  // Solution code here...
  let removedVowels = /[aeiou]/gi
  let consonantRemaining = str.replace(removedVowels, '_')

  return consonantRemaining;
};
